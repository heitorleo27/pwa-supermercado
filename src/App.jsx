...
/*APP*/
export default function App({ updateSW }) { // Passando a prop updateSW
  return (
    // CORREÇÃO: Usamos o HashRouter (melhor para PWA em subdiretórios)
    // E garantimos que seja o único elemento no return
    <HashRouter>
      <AppRouter updateSW={updateSW} />
    </HashRouter>
  );
}